...
os.system("gmx_mpi grompp -f em_2016.mdp -c conf_water.gro -maxwarn 3")
os.system("mpirun -n {n_proc} gmx_mpi mdrun -c conf_emin.gro -ntomp 1".format(n_proc=n_proc))
os.system("gmx_mpi grompp -f npt_2016.mdp -c conf_emin.gro -maxwarn 3")
...
os.system("gmx_mpi grompp -f nvt_2016_EQUIL.mdp -c conf_npt.gro -maxwarn 3")
